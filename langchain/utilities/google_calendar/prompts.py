...
Based on this prompt:\n'Move Joey's birthday to tomorrow at 7 pm' output a json of the following parameters: \n
...
Date format: YYYY-MM-DDThh:mm:ss+00:00
Event duration is {event_duration} seconds and is calculated as the difference between event_end_time and event_start_time.
Today's datetime on UTC time {date} and timezone of the user {u_timezone},
of the user is -5, take into account the timezone of the user and today's date.
Based on this prompt: {query} output a json of the following parameters: \n
